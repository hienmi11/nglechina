function addEvt(){
	$(".mobile-menu").on("click",function(){
		if($(".mobile-body").hasClass("display-n")){
			goOpen();
		}else{
			goClose();
		}
	...
	$(".mobile-tab").on("click",function(){
		...
		$('html,body').stop(true).animate({
           'scrollTop': $(divScrollToAnchor).offset().top - 10
        }, 1000);
	...
	/*$(".business-block").on("click",function(){
		...
		if(classNm == '.business-one'){
			
	    	$(classNm).fadeIn(1000);
		   	$(classNm).removeClass("display-n");
		}
	})*/
...
function goOpen(){
	...
	$(".bggray").attr("style","display:block;");
	$('body').css({'overflow': 'hidden', 'height': '100%'});
	$(".mobile-menu").find("img").attr("src","/images/close.png");
}
function goClose(){
	$(".mobile-body").fadeOut(1000);			
	$(".bggray").attr("style","display:none;");
	$('body').css({'overflow': 'vissible', 'height': '100%'});
	$(".mobile-body").addClass("display-n");
	$(".mobile-menu").find("img").attr("src","/images/open.png");
}
...
} else {// console.log('Infinite Scroll not defined.');
}
...
(function($) {
            ...
            if (lazyLoadEl.length > 0) {
                lazyLoadEl.each(function() {
                    ...
                    element.attr('src', 'images/blank.svg').css({
                        'background': 'url(images/preloader-dark.gif) no-repeat center center #FFF'
                    });
    ...
    SEMICOLON.widget = {
            ...
            if ($toggle.length > 0) {
                $toggle.each(function() {
                    ...
                    element.children('.togglet').click(function() {
                        element.children('.togglet').children('span').html(element.children('.togglet').children('span').html() === '+' ? '-' : '+')
        ...
        extras: function() {
            ...
            } else {//console.log('extras: Bootstrap Tooltip not defined.');
            }

            if ($().popover) {
                $('[data-toggle=popover]').popover();
            } else {//console.log('extras: Bootstrap Popover not defined.');
            }
            ...
            var t = setTimeout(function() {
                ...
                if ($gridContainer.length > 0) {
                    if (!$gridContainer.hasClass('.customjs')) {
                        ...
                        } else {//console.log('documentOnResize > init: Isotope not defined.');
                        }
                    }
                }
                if ($body.hasClass('device-lg') || $body.hasClass('device-md')) {
    ...
    SEMICOLON.documentOnReady = {
        ...
        windowscroll: function() {
            ...
            if ($onePageMenuEl.length > 0) {
                ...
                } else {//console.log('windowscroll: Scrolled Function not defined.');
                }
            }
        }
